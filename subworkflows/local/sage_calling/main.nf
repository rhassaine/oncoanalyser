...
workflow SAGE_CALLING {
    ...
    ch_tumor_tsv                 // channel: [mandatory] [ meta, dup_freq_tsv, jitter_tsv, bqr_tsv, ms_tsv ]
    ch_normal_tsv                // channel: [mandatory] [ meta, dup_freq_tsv, jitter_tsv, bqr_tsv, ms_tsv ]
    ch_donor_tsv                 // channel: [mandatory] [ meta, dup_freq_tsv, jitter_tsv, bqr_tsv, ms_tsv ]
    ...
    ch_inputs_sorted = WorkflowOncoanalyser.groupByMeta(
        ...
        .map { meta,
            ...
            tumor_dup_freq_tsv,  tumor_jitter_tsv,  tumor_bqr_tsv,  tumor_ms_tsv,
            normal_dup_freq_tsv, normal_jitter_tsv, normal_bqr_tsv, normal_ms_tsv,
            donor_dup_freq_tsv,  donor_jitter_tsv,  donor_bqr_tsv,  donor_ms_tsv ->
