...
workflow SAGE_CALLING {
    ...
    ch_tumor_tsv                 // channel: [mandatory] [ meta, dup_freq_tsv, jitter_tsv, bqr_tsv, bqr_png, ms_tsv ]
    ch_normal_tsv                // channel: [mandatory] [ meta, dup_freq_tsv, jitter_tsv, bqr_tsv, bqr_png, ms_tsv ]
    ch_donor_tsv                 // channel: [mandatory] [ meta, dup_freq_tsv, jitter_tsv, bqr_tsv, bqr_png, ms_tsv ]
    ...
    ch_inputs_sorted = WorkflowOncoanalyser.groupByMeta(
        ...
        .map { meta,
            ...
            tumor_dup_freq_tsv,  tumor_jitter_tsv,  tumor_bqr_tsv,  tumor_bqr_png,  tumor_ms_tsv,
            normal_dup_freq_tsv, normal_jitter_tsv, normal_bqr_tsv, normal_bqr_png, normal_ms_tsv,
            donor_dup_freq_tsv,  donor_jitter_tsv,  donor_bqr_tsv,  donor_bqr_png,  donor_ms_tsv ->
            ...
            def redux_tsv_list = [
                ...
                tumor_bqr_png ?: Utils.getInput(meta, Constants.INPUT.REDUX_BQR_PNG_TUMOR),
                ...
                normal_bqr_png ?: Utils.getInput(meta, Constants.INPUT.REDUX_BQR_PNG_NORMAL),
                ...
                donor_bqr_png ?: Utils.getInput(meta, Constants.INPUT.REDUX_BQR_PNG_DONOR),
