...
workflow REDUX_PROCESSING {
    ...
    // Combine TSV and PNG outputs into single channel for processing
    // channel: [ meta_redux, bam, bai, dup_freq_tsv, jitter_tsv, bqr_tsv, bqr_png, ms_tsv ]
    ...
    ch_redux_out_sorted = ch_redux_out
        .branch { meta_redux, bam, bai, dup_freq_tsv, jitter_tsv, bqr_tsv, bqr_png, ms_tsv ->
    ...
    // Set outputs, restoring original meta, split into BAMs and TSVs/PNGs
    // channel: [ meta, bam, bai, dup_freq_tsv, jitter_tsv, bqr_tsv, bqr_png, ms_tsv ]
    ch_redux_tumor_out = Channel.empty()
        ...
        .multiMap { meta, bam, bai, dup_freq_tsv, jitter_tsv, bqr_tsv, bqr_png, ms_tsv ->
            bam: [meta, bam, bai]
            tsv: [meta, dup_freq_tsv, jitter_tsv, bqr_tsv, bqr_png, ms_tsv]
        }
    ...
    dna_tumor_tsv  = ch_redux_tumor_out.tsv  // channel: [ meta, dup_freq_tsv, jitter_tsv, bqr_tsv, bqr_png, ms_tsv ]
    dna_normal_tsv = ch_redux_normal_out.tsv // channel: [ meta, dup_freq_tsv, jitter_tsv, bqr_tsv, bqr_png, ms_tsv ]
    dna_donor_tsv  = ch_redux_donor_out.tsv  // channel: [ meta, dup_freq_tsv, jitter_tsv, bqr_tsv, bqr_png, ms_tsv ]
